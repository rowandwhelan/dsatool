...
document.addEventListener("change", graphChart);
    ...
    function graphChart() {
      ...
      if (document.getElementById("shields").checked) {
        graphDataSet.push({ label: 'Shield Cores', data: cores , borderWidth: borderWidth, pointStyle: false }, { label: 'Shield Generators', data: gens , borderWidth: borderWidth, pointStyle: false }, { label: 'Shield Projectors', data: projs , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("turrets").checked) {
        graphDataSet.push({ label: 'RC Turret', data: rcs , borderWidth: borderWidth, pointStyle: false }, { label: 'Auto Turret', auto: auto , borderWidth: borderWidth, pointStyle: false }, { label: 'Burst Turret', burst: burst , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("rares").checked) {
        graphDataSet.push({ label: 'Gold Null Trophy', data: goldNull , borderWidth: borderWidth, pointStyle: false }, { label: 'Silver Null Trophy', data: silverNull , borderWidth: borderWidth, pointStyle: false }, { label: 'Bug Hunter Trophy', data: bug , borderWidth: borderWidth, pointStyle: false }, { label: 'Golden Shredder', data: shredder , borderWidth: borderWidth, pointStyle: false }, { label: 'Legacy Fabricator', data: legacy , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("misc").checked) {
        graphDataSet.push({ label: 'Ice Glass', data: glass , borderWidth: borderWidth, pointStyle: false }, { label: 'Flux RCD', data: rcd , borderWidth: borderWidth, pointStyle: false }, { label: 'Backpack', data: backpack , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("scanners").checked) {
        graphDataSet.push({ label: 'Blueprint Scanner', data: bp , borderWidth: borderWidth, pointStyle: false }, { label: 'Manifest Scanner', data: manifest , borderWidth: borderWidth, pointStyle: false }, { label: 'BoM Scanner', data: bom , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("balls").checked) {
        graphDataSet.push({ label: 'Volleyball', data: volleyball , borderWidth: borderWidth, pointStyle: false }, { label: 'Basketball', data: basketball , borderWidth: borderWidth, pointStyle: false }, { label: 'Beach Ball', data: beachball , borderWidth: borderWidth, pointStyle: false }, { label: 'Football', data: football , borderWidth: borderWidth, pointStyle: false })
      }
      if (document.getElementById("vulture").checked) {
        graphDataSet.push({ label: 'Turret Booster - Rapid Fire', data: rapid , borderWidth: borderWidth, pointStyle: false }, { label: 'Turret Booster - Preservation', data: pres , borderWidth: borderWidth, pointStyle: false }, { label: 'Enhanced Turret Controller', data: controller , borderWidth: borderWidth, pointStyle: false })
      }
