...
combined();
  ...
  function combined(){
    ...
    document.getElementById("output").innerHTML += `<br><h3> Auto Turret: ${Number(((avg2(auto2) / avg(auto)) * 0.1 * value1(auto1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Burst Turret: ${Number(((avg2(burst2) / avg(burst)) * 0.1 * value1(burst1)).toPrecision(3) )}</h3>`;
    ...
    document.getElementById("output").innerHTML += `<br><h3> Hyper Ice: ${Number(((avg2(glass2) / avg(glass)) * 2.5 * value1(glass1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> RCD: ${Number(((avg2(rcd2) / avg(rcd)) * 0.5 * value1(rcd1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Backpack: ${Number(((avg2(backpack2) / avg(backpack)) * 0.2 * value1(backpack1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Blueprint Scanner: ${Number(((avg2(bp2) / avg(bp)) * 0.6 * value1(bp1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Manifest Scanner: ${Number(((avg2(manifest2) / avg(manifest)) * 0.2 * value1(manifest1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> BOM Scanner: ${Number(((avg2(bom2) / avg(bom)) * 0.2 * value1(bom1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Volleyball: ${Number(((avg2(volleyball2) / avg(volleyball)) * 0.3 * value1(volleyball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Basketball: ${Number(((avg2(basketball2) / avg(basketball)) * 0.3 * value1(basketball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Football: ${Number(((avg2(football2) / avg(football)) * 0.3 *value1(football1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Beach Ball: ${Number(((avg2(beachball2) / avg(beachball)) * 0.3 * value1(beachball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Rapid-Fire: ${Number(((avg2(rapid2) / avg(rapid)) * 0.1* value1(rapid1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Preservation: ${Number(((avg2(pres2) / avg(pres)) * 0.1 * value1(pres1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Advanced Turret Controllers: ${Number(((avg2(control2) / avg(control)) * 0.2 *value1(control1)).toPrecision(3) )}</h3>`; 
  }
