...
combined();
  ...
  function combined(){
    ...
    document.getElementById("output").innerHTML += `<br><h3> Shield Generators: ${Number(((avg2(gens2) / avg(gens)) * 1.2 * value1(gens1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Shield Projectors: ${Number(((avg2(projs2) / avg(projs)) * 0.65 * value1(projs1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> RCs: ${Number(((avg2(rcs2) / avg(rcs)) * 3 * value1(rcs1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Auto Turret: ${Number(((avg2(auto2) / avg(auto)) * 0.2 * value1(auto1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Burst Turret: ${Number(((avg2(burst2) / avg(burst)) * 0.2 * value1(burst1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Gold Null Trophy: ${value(goldNull) * 1.8}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Silver Null Trophy: ${value(silverNull) * 1.8}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Bug Hunter Trophy: ${value(bug) * 1.8}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Golden Shredder: ${value(shredder)}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Legacy Fabricator: ${value(legacy) * 2.8}</h3>`;
    ...
    document.getElementById("output").innerHTML += `<br><h3> Backpack: ${Number(((avg2(backpack2) / avg(backpack)) * 0.25 * value1(backpack1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Blueprint Scanner: ${Number(((avg2(bp2) / avg(bp)) * 0.8 * value1(bp1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Manifest Scanner: ${Number(((avg2(manifest2) / avg(manifest)) * 0.25 * value1(manifest1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> BOM Scanner: ${Number(((avg2(bom2) / avg(bom)) * 0.25 * value1(bom1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Volleyball: ${Number(((avg2(volleyball2) / avg(volleyball)) * 0.8 * value1(volleyball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Basketball: ${Number(((avg2(basketball2) / avg(basketball)) * 0.8 * value1(basketball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Football: ${Number(((avg2(football2) / avg(football)) * 0.8 *value1(football1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Beach Ball: ${Number(((avg2(beachball2) / avg(beachball)) * 0.8 * value1(beachball1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Rapid-Fire: ${Number(((avg2(rapid2) / avg(rapid)) * 0.2* value1(rapid1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Preservation: ${Number(((avg2(pres2) / avg(pres)) * 0.2 * value1(pres1)).toPrecision(3) )}</h3>`;
    document.getElementById("output").innerHTML += `<br><h3> Advanced Turret Controllers: ${Number(((avg2(control2) / avg(control)) * 0.25 *value1(control1)).toPrecision(3) )}</h3>`; 
  }
